...
To prepare the examples type in project root: `make prepare-example-data`

### Ondemand report generation on the commandline

To run this example type in project root: `make run-example-basic-console`

Quickly analyze on the commandline:
